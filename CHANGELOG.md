...
section, running header, optional endnotes). Needed for a real manuscript ("A Cloud Made of
Concrete") with nine reference appendices between the last chapter and the bibliography;
...
manuscript ("A Cloud Made of Concrete") into this project structure — the tooling had no way
